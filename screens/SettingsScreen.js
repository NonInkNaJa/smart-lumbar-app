    ...
    <Screen>
      <ScrollView contentContainerStyle={screen.scrollContent}>
        ...
        <Card index={4}>
          ...
          <Text style={styles.infoLine}>แสดงสถานะท่านั่ง (เขียว/แดงเหมือนป้ายบนหน้า Home) เวลานั่งต่อเนื่อง และคะแนนความพร้อมเป็นแท่งสีเล็กๆ บนหน้าจอหลักของมือถือ โดยไม่ต้องเปิดแอป</Text>
          <Text style={styles.infoLine}>วิธีเพิ่ม: กดค้างที่พื้นที่ว่างบนหน้าจอหลัก &gt; วิดเจ็ต &gt; หลังเทพ</Text>
          <Text style={styles.infoLine}>อัปเดตทุกครั้งที่สถานะหรือเวลานั่งเปลี่ยน (ทุกนาทีตอนเชื่อมต่อเข็มขัดอยู่) และระบบรีเฟรชเองอย่างน้อยทุก ~30 นาที ถ้าแอปไม่ส่งข้อมูลเกิน 10 นาที วิดเจ็ตจะแสดง "ไม่มีข้อมูล"</Text>
